...
- **Closed this iteration:** #211 (inline string literals — VariableDeclaration target inlining), #207 (comparison operators — defect 1 fixed, defects 2-3 are accumulator state loss).
