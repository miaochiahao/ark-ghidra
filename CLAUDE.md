...
21. Real .abc file support: test with actual HarmonyOS compiler output (#25)
22. Performance: large file handling and incremental decompilation
...
- **Test count tracking:** 1025 tests across 19 test suites (as of 2026-05-09). After any decompiler change, check that existing tests still match expected output strings.
