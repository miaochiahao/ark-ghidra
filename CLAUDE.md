...
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~1240 methods on known-source test HAPs (Rounds 1-37) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
...
- **Known-source test HAPs (37 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-37}_*.{ets,ts}`.
