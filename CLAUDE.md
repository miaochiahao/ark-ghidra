...
- **Test count tracking:** 1124 tests across 19 test suites (as of 2026-05-09). After any decompiler change, check that existing tests still match expected output strings.
