...
- **Quality metrics (Kazumi, 3632 methods):** if(undefined)=0, while=78, for=14, do-while=65, if=1247, switch=4, try=456, lex_=3621, unknown_=29, new acc()=71, func_=351, acc.=844, if(!)=20 (was 452, reduced 96% by negated comparison simplification). Acc-value ternary: 4 `return cond ? a : b` patterns detected. Unknown opcodes (29 total): alignment artifacts, not real opcodes.
...
- **Priority:** Fix decompiler quality issues. Vendor opcodes DD-E1 now fully handled. Key remaining: constructor callee recovery (71 `new acc()` on Kazumi), func_ name resolution (351 remaining), lex_ variable names (3621), acc. leakage (844 method call sites), try-catch body reconstruction.
