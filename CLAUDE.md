...
- **replaceVariable completeness:** Now handles 20+ expression types: Binary, Unary, Call, Member, Assign, New, Conditional, CompoundAssign, LogicalAssign, Increment, Await, Yield, Spread*, TemplateLiteral, ArrayLiteral, ObjectLiteral, As, NonNull, OptionalChain*, BuiltInNew. Only returns null for truly unknown expression types.
