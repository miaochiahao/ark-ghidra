...
- **Priority:** Fix decompiler quality issues. Vendor opcodes DD-E1 now fully handled. Key remaining: constructor callee recovery (71 `new acc()` on Kazumi), acc. method leakage (844 sites, mostly `acc.set`), lex_ variable names (3621), try-catch body reconstruction (456 try blocks).
