...
- **Open issues as of 2026-05-11:** #72, #73, #184, #185, #186, #187, #189, #190, #191, #192, #193, #194, #195, #196, #197, #198, #199, #200, #201 (19 total). Critical: #199 (systematic binary operand swap for -,*,/,%,<<,>>,>>>).
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~370 methods on known-source test HAPs (Rounds 1-14) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
- **Known-source test HAPs (14 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-14}_*.{ets,ts}`.
