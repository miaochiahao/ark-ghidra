...
35. feat: test with real HarmonyOS .abc files from Ark compiler #25
...
- **Test count tracking:** 1318 tests across 20+ test suites (as of 2026-05-09). After any decompiler change, check that existing tests still match expected output strings.
