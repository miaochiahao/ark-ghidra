...
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~1285 methods on known-source test HAPs (Rounds 1-38) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
