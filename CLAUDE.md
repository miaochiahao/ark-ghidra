...
- **Quality metrics (entry-default-unsigned.hap, 5874 methods):** if(undefined)=0 (was 207→0 via pipeline fix), new N()=0 (was 5→0), func_=368 (was 3348→368 via name resolution), lex_0=4428 (was 4648→4428 via inference), throw acc=13, unknown_=14. Total lines: 72679 (was 74570, ~1900 lines dead code removed).
