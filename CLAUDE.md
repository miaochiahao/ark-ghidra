...
- **Open issues as of 2026-05-11:** #184, #185, #186, #196, #197, #198, #200, #201, #202, #203, #205, #206 (12 total). Issues #72, #73, #187, #189-#195, #199, #204 closed. Critical remaining: #196-#203 (CFG reconstruction, boolean logic, try-catch), #205 (typeof guard empty body), #206 (reserved keyword as variable name).
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~1020 methods on known-source test HAPs (Rounds 1-32) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
...
- **Known-source test HAPs (32 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-32}_*.{ets,ts}`.
...
- **Reserved keyword variable names (issue #206):** Map/Set `.delete()` return values get assigned to variable named `delete`, which is a JS/ArkTS reserved keyword. Decompiler must sanitize generated variable names against the reserved keyword list.
