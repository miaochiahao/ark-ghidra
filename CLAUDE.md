...
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~720 methods on known-source test HAPs (Rounds 1-25) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
...
- **Known-source test HAPs (25 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-25}_*.{ets,ts}`.
