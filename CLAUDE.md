...
- **Open issues as of 2026-05-10:** #72, #73, #184, #185, #186, #187, #189, #190, #191, #192, #193, #194, #195, #196 (14 total). Recent: #193 (constructor args swapped), #194 (optional chaining/nullish coalescing empty), #195 (switch-default/instanceof/try-catch/static methods), #196 (do-while/recursive/function refs/chained &&).
- **E2E stats:** 27,389 methods across 6 HAP files (real-world), ~230 methods on known-source test HAPs (Rounds 1-9) — 0 failures, 0 timeouts, 0 unhandled opcodes across all.
- **Known-source test HAPs (9 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-9}_*.{ets,ts}`.
- **Patterns tested across rounds:** Math/bitwise/string/array methods, class/inheritance, try-catch, Map/Set, Promise, generics, closures, recursion, typeof guards, enum, RegExp, ArrayBuffer/DataView, WeakRef, lifecycle, readonly, sort, matrix, string pad/trim, TypedArrays, optional chaining, nullish coalescing, interface impl, Map.forEach, ternary, instanceof, while-break-continue, switch-default, static members, do-while, array every/some/map, chained calls, number conversions, escape strings, recursive fibonacci, array concat.
