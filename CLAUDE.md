...
- **Open issues as of 2026-05-11:** #184, #185, #186, #196, #197, #200, #201, #202, #203 (9 total). Issues #72, #73, #187, #189-#195, #198, #199, #204, #205, #206 closed. Critical remaining: #196 (chained && partially fixed), #200-#203 (loop bodies, try-catch).
- **E2E stats:** 27,389+ methods across 6 HAP files (real-world), ~1285 methods on known-source test HAPs (Rounds 1-38) — 0 failures, 0 timeouts, 0 unhandled opcodes across all. Melotopia 11,788 methods, Kazumi 3,632 methods — both fully decompiled.
...
- **Known-source test HAPs (38 rounds):** Built from `/Users/anakin/DevEcoStudioProjects/MyApplication`. Each round tests specific language patterns. Baselines in `data/test_hap/arkts-decompile-test{1-38}_*.{ets,ts}`.
